<div id="help-template" class="outer">
    ...
    <p class="even">The module was created to manage your photo album in a fashionable Web 2.0 way.<br> <br>
    </p>
    ...
    <p class="even">
        Tutorial has been started, but we might need your help! Please check out the status of the tutorial <a href="https://www.gitbook.com/book/xoops/<{$smarty.const._MI_TDMPICTURE_DIRNAME}>-tutorial/" target="_blank">here </a>.
        <br><br>To contribute to this Tutorial, <a href="https://github.com/XoopsDocs/<{$smarty.const._MI_TDMPICTURE_DIRNAME}>-tutorial/" target="_blank">please fork it on GitHub</a>.
    ...
    <p class="even">
        This module is Open Source and we would love your help in making it better! You can fork this module on <a href="https://github.com/XoopsModulesArchive/tdmpicture" target="_blank">GitHub</a><br><br>
